...
import { deleteUserProductAPI, getUserProductAPI } from '../services/allAPIs';
    ...
    <div className='container'>    
       <div className='text-center'>
        ...
        <div className='d-flex'>
             <h2 className='text-center' style={{marginLeft:'400px'}}>Delete Products</h2>
...

               {
                allUserProduct.length>0?allUserProduct.map((item)=>(
                  <tr>
                        ...
                        {/* <td>
                            <button className='btn'style={{backgroundColor:'#F8BBD0'}}><EditCart product={item}/></button>
                        </td> */}
                        <td>
